...
namespace Gadgetron{
  ...
  gpuRadialPrepGadgetFCRL::gpuRadialPrepGadgetFCRL()
    : slices_(-1)
    , sets_(-1)
    , device_number_(-1)
    , mode_(-1)
  ...
  int gpuRadialPrepGadgetFCRL ::process_config(ACE_Message_Block* mb)
  {
    //GDEBUG("gpuRadialPrepGadgetFCRL::process_config\n");
          ...
          GadgetContainerMessage< hoNDArray< std::complex<float> > > *m2)
  {
    ...
    //GDEBUG("gpuRadialPrepGadgetFCRL::process\n");

    boost::shared_ptr<GPUTimer> process_timer;
    if( output_timing_ )
      process_timer = boost::shared_ptr<GPUTimer>( new GPUTimer("gpuRadialPrepGadgetFCRL::process()") );
  ...
  int 
  gpuRadialPrepGadgetFCRL::calculate_trajectory_for_reconstruction(long profile_offset, unsigned int set, unsigned int slice)
  {   
  ...
  int
  gpuRadialPrepGadgetFCRL::calculate_density_compensation_for_reconstruction( unsigned int set, unsigned int slice)
  {
  ...
  gpuRadialPrepGadgetFCRL::calculate_trajectory_for_frame(long profile_offset, unsigned int set, unsigned int slice)
  {
  ...
  gpuRadialPrepGadgetFCRL::calculate_density_compensation_for_frame(unsigned int set, unsigned int slice)
  {    
  ...
  boost::shared_ptr< cuNDArray<floatd2> > 
  gpuRadialPrepGadgetFCRL::calculate_trajectory_for_rhs(long profile_offset, unsigned int set, unsigned int slice)
  {
  ...
  boost::shared_ptr< cuNDArray<float> >
  gpuRadialPrepGadgetFCRL::calculate_density_compensation_for_rhs(unsigned int set, unsigned int slice)
  {
  ...
  boost::shared_ptr< hoNDArray<float_complext> > gpuRadialPrepGadgetFCRL::
  ...
  gpuRadialPrepGadgetFCRL::duplicate_profile( GadgetContainerMessage< hoNDArray< std::complex<float> > > *profile )
  {
  ...
  void gpuRadialPrepGadgetFCRL::reconfigure(unsigned int set, unsigned int slice, bool use_dcw)
  {    
  ...
  float gpuRadialPrepGadgetFCRL::fcrl_get_custom_angle(long acq_index)
  {
